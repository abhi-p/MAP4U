...
const vector<t_color> t_color::predef_colors = {
    ...
    t_color(0xF0, 0x80, 0x80),//If we need to revert just dlete this line and uncomment the lineabove
    ...
    //t_color(0x32, 0xCD, 0x32) // "limegreen"
        t_color(0XC4,0XD1,0X89),//If we need to revert just dlete this line and uncomment the lineabove
